/**
 * List types and classes used by the file list. Kept in a separate module
 * so db.ts can import them without creating a circular dependency (FileList
 * and Selection import db).
 */
